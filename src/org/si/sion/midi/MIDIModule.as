...
package org.si.sion.midi {
    ...
    //--------------------------------------------------------------------------------
        ...
        function MIDIModule(polyphony:int=32, midiChannelCount:int=16, systemExclusiveMode:String="")
        {
            ...
            setDrumExclusiveGroup(1, [42,44,46]); // hi-hat
            setDrumExclusiveGroup(2, [80,81]);    // triangle
    ...
    //--------------------------------------------------------------------------------
        ...
        public function noteOn(channelNum:int, note:int, velocity:int=64) : void
        {
            ...
            if (_dispatchFlags & 1) _sionDriver._sion_internal::_dispatchMIDIEvent(SiONMIDIEvent.NOTE_ON, track, channelNum, note, velocity);
        }
        ...
        private function _noteOffOperator(ope:MIDIModuleOperator) : void
        {
            ...
            _activeOperators.remove(ope);
            _freeOperators.push(ope);
            if (_dispatchFlags & 2) _sionDriver._sion_internal::_dispatchMIDIEvent(SiONMIDIEvent.NOTE_OFF, ope.sionTrack, channelNum, note, 0);
        }
        ...
        public function programChange(channelNum:int, programNumber:int) : void
        {
            ...
            if (_dispatchFlags & 8) _sionDriver._sion_internal::_dispatchMIDIEvent(SiONMIDIEvent.PROGRAM_CHANGE, null, channelNum, 0, programNumber);
        }
        ...
        public function pitchBend(channelNum:int, bend:int) : void
        {
            ...
            if (_dispatchFlags & 16) _sionDriver._sion_internal::_dispatchMIDIEvent(SiONMIDIEvent.PITCH_BEND, null, channelNum, 0, bend);
        }
        ...
        public function controlChange(channelNum:int, controlerNumber:int, data:int) : void
        {
            ...
            if (_dispatchFlags & 4) _sionDriver._sion_internal::_dispatchMIDIEvent(SiONMIDIEvent.CONTROL_CHANGE, null, channelNum, controlerNumber, data);
