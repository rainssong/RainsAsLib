...
package me.rainui.components {
	...
	public class Box extends Component{
		...
		/**添加显示对象*/
		public function addComponent(element:DisplayObject, x:Number, y:Number):void {
			element.x = x;
			element.y = y;
			addChild(element);
		}
		...
		/**增加显示对象到index层*/
		public function addComponentAt(element:DisplayObject, index:int, x:Number, y:Number):void {
			element.x = x;
			element.y = y;
		...
		/**批量增加显示对象*/
		public function addComponents(elements:Array):void {
		...
		public function removeComponent(element:DisplayObject):void {
