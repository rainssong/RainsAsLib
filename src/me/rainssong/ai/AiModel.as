...

{
	 ...
	 */
	public class AiModel extends Object
	{
		...
		/**
		 * Handles all basic motion. Should be called on each frame / timer
		   interval.
		 */
...
// rotate heading to match velocity
		...
		/**
		 * Sets x position of character. Overrides Sprite.x to set internal
		   Vector2D position as well.
		 */
		...
		/**
		 * Sets y position of character. Overrides Sprite.y to set internal
		   Vector2D position as well.
		 */
