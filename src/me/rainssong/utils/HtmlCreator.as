package me.rainssong.utils
{
	...
	public class HtmlCreator
	{
		...
		public static function createVideoHtml(videoURL:String, width:String="100%", height:String="100%"):String
		{
		...
		public static function createPdfHtml(pdfURL:String, width:String="100%", height:String="100%"):String
		{
