...
package com.greensock.loading {
	...
	/** Dispatched when the video's buffer is full. **/
	[Event(name="videoBufferFull", type="com.greensock.loading.VideoLoader")]
	/** Dispatched when the video's buffer is empty. **/
	[Event(name="videoBufferEmpty", type="com.greensock.loading.VideoLoader")]
	/** Dispatched when the video pauses due to a <code>pauseVideo()</code> call or changing the <code>videoPaused</code> property to <code>true</code>. **/
	[Event(name="videoPause", type="com.greensock.loading.VideoLoader")]
	/** Dispatched when the video plays due to a <code>playVideo()</code> call or changing the <code>videoPaused</code> property to <code>false</code> or when <code>autoPlay</code> is <code>true</code> and the video beings playing after enough has been loaded into the buffer. **/
	...
	/** Dispatched when a cue point is reached while playing the video. Use the LoaderEvent's <code>data</code> property to get info about the particular cue point. **/
	[Event(name="videoCuePoint", type="com.greensock.loading.VideoLoader")]
	/** Dispatched when progress is made during playback (only dispatched while the video is playing). **/
	[Event(name="playProgress", type="com.greensock.loading.VideoLoader")]
/**
