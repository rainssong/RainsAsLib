...
:: Android packaging
set AND_CERT_NAME="ResumeDownload"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\ResumeDownload.p12
...
set IOS_PROVISION=cert\Rainssong.mobileprovision
set IOS_ICONS=icons\
...
set APP_ID=cn.eDoctor.Rainssong

:: Output packages
set DIST_PATH=bin-release
set DIST_NAME=ResumeDownload
