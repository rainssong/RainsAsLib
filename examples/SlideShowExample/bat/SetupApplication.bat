...
:: Android packaging
set AND_CERT_NAME="SlideShowExample"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SlideShowExample.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=cert\rainssong_dis.p12
set IOS_DEV_CERT_FILE=cert\rainssong_dev.p12
set IOS_DEV_CERT_PASS=123456
set IOS_DEV_PROVISION=cert\RainssongDev.mobileprovision
set IOS_DIST_PROVISION=cert\RainssongDist.mobileprovision
...
set DIST_NAME=SlideShowExample
